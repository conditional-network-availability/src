...
#define FUNCID_TX_SYNC_RAW UL(22)
#define FUNCID_TX_TOS_OEN (FUNCID_TX_SYNC_RAW << FUNCID_OEN_SHIFT)
#define FUNCID_TX_TOS (FUNCID_TX_TOS_OEN | FUNCID_TYPE)

#define FUNCID_TX_ACK_RAW UL(23)
#define FUNCID_TX_FRS_OEN (FUNCID_TX_ACK_RAW << FUNCID_OEN_SHIFT)
#define FUNCID_TX_FRS (FUNCID_TX_FRS_OEN | FUNCID_TYPE)

#define FUNCID_RX_SYNC_RAW UL(24)
#define FUNCID_RX_FRS_OEN (FUNCID_RX_SYNC_RAW << FUNCID_OEN_SHIFT)
#define FUNCID_RX_FRS (FUNCID_RX_FRS_OEN | FUNCID_TYPE)

#define FUNCID_RX_ACK_RAW UL(25)
#define FUNCID_RX_TOS_OEN (FUNCID_RX_ACK_RAW << FUNCID_OEN_SHIFT)
