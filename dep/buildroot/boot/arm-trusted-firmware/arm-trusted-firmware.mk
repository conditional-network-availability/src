...
else ifeq ($(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DIR),y)
ARM_TRUSTED_FIRMWARE_SITE = $(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DIR_URL))
...
define ARM_TRUSTED_FIRMWARE_BUILD_CMDS
	...
	# We need to copy over our implementation from the src directory
	cp -r $(ARM_TRUSTED_FIRMWARE_SITE)/../../src/sw $(@D)/services/nic
